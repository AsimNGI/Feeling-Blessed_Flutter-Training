...
class FundraisingCampaignItem extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Padding(padding: AppPadding.all2, child: _coverImage(campaign.imageUrl)),
                ConstrainedBox(
                          ...
                          children: [
                            if (campaign.totalAmountRaisedLabel != null &&
                              ...
                              Text(
                                ...
                                style: AppStyles.of(
                                  context,
                                ).bodySmall.copyWith(color: AppColors.gray600),
                              ),
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        campaign.orgName!,
                        style: AppStyles.of(context).bodySmall.copyWith(color: AppColors.black),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                    ),
  ...
  Widget _placeholder() => const Center(child: Icon(Icons.volunteer_activism, size: 48));
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: LinearProgressIndicator(
        ...
        valueColor: const AlwaysStoppedAnimation<Color>(AppColors.fundraiserProgressBackground),
      ),
    );
  }
}
