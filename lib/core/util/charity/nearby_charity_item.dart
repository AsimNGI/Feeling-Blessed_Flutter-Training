...
class NearbyCharityItem extends StatelessWidget {
  const NearbyCharityItem({super.key, required this.charity, required this.totalItems, this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        width: itemWidth,
        padding: EdgeInsets.symmetric(horizontal: AppPadding.w16, vertical: AppPadding.h16),
          ...
          children: [
            ...
            if (charity.cityCountry != null && charity.cityCountry!.isNotEmpty)
              Padding(
                ...
                child: Text(
                  charity.cityCountry!,
                  style: AppStyles.of(context).bodySmall.copyWith(color: AppColors.gray600),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                ),
              )
  ...
  Widget _iconPlaceholder() => Icon(Icons.volunteer_activism, size: 32, color: AppColors.gray600);
}
