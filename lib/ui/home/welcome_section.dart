...
import 'package:flutter_training/ui/home/onboarding_card_item.dart';
...
class WelcomeSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (final item in onBoardingSection) {
      ...
      visibleCards.add(OnboardingCard(
        emoji: card.emoji,
        title: card.title,
    ...
    final title =
        isGuestUser ? 'As-salaamu alaykum' : 'As-salaamu alaykum, $userName';
