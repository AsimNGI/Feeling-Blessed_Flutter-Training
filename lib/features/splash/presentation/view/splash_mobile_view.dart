...
import 'package:flutter_training/features/dashboard/domain/entities/response/data_source.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SizedBox.expand(
        child: Center(child: FlutterLogo(size: AppConstant.splashLogoSize)),
      ),
    );
  }
}
