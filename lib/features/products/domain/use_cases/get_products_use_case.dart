...
class GetProductsUseCase extends NoParamsUseCase<DataState<List<Product>>> {
  GetProductsUseCase(this._contract);

  final ProductsContract _contract;

  @override
  Future<DataState<List<Product>>> call() => _contract.getProducts();
}
