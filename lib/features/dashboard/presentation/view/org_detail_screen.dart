...
import 'package:flutter_training/features/dashboard/domain/entities/response/org_detail_data.dart';
import 'package:flutter_training/features/dashboard/domain/entities/response/organization.dart';
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        c.flagOrIcon,
                        style: TextStyle(fontSize: AppFontSizes.sp20),
                      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(AppStrings.peopleDonatedSummary, style: s.bodyMedium),
          ),
        ],
      ),
    );
  ...
  Widget _buildRecentDonationsList(BuildContext context, AppStyles s) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final frameStyle =
            _avatarFrameStyles[index % _avatarFrameStyles.length];
        return Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Center(
              child: Text(
                AppStrings.donate,
                style: s.bodyMedium.copyWith(color: Colors.white),
              ),
            ),
          ),
        ),
