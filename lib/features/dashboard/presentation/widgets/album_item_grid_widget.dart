      ...
      child: Stack(
        ...
        children: [
          ...
          Positioned(
            ...
            child: ClipRect(
              child: BackdropFilter(
                filter: ImageFilter.blur(sigmaX: AppPadding.w2, sigmaY: AppPadding.w2),
                child: Container(
                  height: AppPadding.h50,
                  decoration: BoxDecoration(color: AppColors.textPrimary.withValues(alpha: 0.2)),
                ),
              ),
            ),
          ),
          ...
          Positioned(
            ...
            left: AppPadding.w8,
            right: AppPadding.w8,
            child: Text(album.id, textAlign: TextAlign.center, style: s.overlayCaption),
          ),
        ],
      ),
    );
