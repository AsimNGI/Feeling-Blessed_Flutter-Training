...
class WelcomeSection extends StatelessWidget {
  ...
  static const Map<String, OnboardingCard> _cardContentMap = {
    'guest_welcome': OnboardingCard(
      ...
      description:
          'Securely save your payment methods and track all your donations in one place',
      buttonText: 'Sign up',
    ),
    ...
    'charity': OnboardingCard(
      ...
      description:
          'Begin your giving journey—choose a charity or fundraiser to donate to',
  ...
  Widget build(BuildContext context) {
    ...
    final title = isGuestUser
        ? 'As-salaamu alaykum'
        : 'As-salaamu alaykum, $userName';
          ...
          if (visibleCards.isNotEmpty) ...[
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, i) =>
                    OnboardingCardItem(card: visibleCards[i]),
              ),
            ),
          ],
        ],
