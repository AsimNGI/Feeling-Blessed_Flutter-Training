...
import 'package:flutter_training/core/utils/charity/fundraising_campaign_item.dart';
import 'package:flutter_training/core/utils/charity/nearby_charity_item.dart';
import 'package:flutter_training/core/utils/charity/suggested_charity_item.dart';
import 'package:flutter_training/features/dashboard/domain/entities/response/new_home_models.dart';
import 'package:flutter_training/features/home/presentation/widgets/section_header.dart';
...
class GenericSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final itemCount = hasOrgs
        ? section.itemsOrg.length
        : (hasDrive ? section.itemsDrive.length : 0);
                ...
                for (var i = 0; i < itemCount; i++) ...[
                  ...
                  if (hasOrgs)
                    ...
                    FundraisingCampaignItem(
                      ...
                      totalItems: itemCount,
                      onTap: () => onFundraiserTap?.call(section.itemsDrive[i]),
                    ),
                ],
              ],
            ),
