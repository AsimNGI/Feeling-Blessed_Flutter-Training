    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'GET STARTED',
            style: s.buttonSmall.copyWith(color: AppColors.gray600, letterSpacing: 1),
          ),
          AppPadding.vertical8,
          Text(
            card.title,
                ...
                children: [
                  ShaderMask(
                    shaderCallback: (bounds) => LinearGradient(
                      colors: [AppColors.primaryAqua600, AppColors.secondaryGreen600],
                    ).createShader(bounds),
                    child: Text(
                      card.buttonText,
                  ...
                  Icon(Icons.arrow_forward_ios, size: 16, color: AppColors.primaryAqua600),
                ],
              ),
            ),
          ),
