    ...
    return HomeData(
      ...
      onBoardingSection:
          (json['onBoardingSection'] as List<dynamic>?)
                  ?.map((e) =>
                      HomeOnboardingItem.fromJson(e as Map<String, dynamic>))
                  .toList() ??
              [],
    );
  }
...
class HomeSection {
  ...
  factory HomeSection.fromJson(Map<String, dynamic> json) {
    ...
    return HomeSection(
      ...
      itemsOrg: itemsOrg
              ?.map((e) => HomeOrgItem.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
      itemsDrive: itemsDrive
              ?.map((e) =>
                  HomeFundraiserItem.fromJson(e as Map<String, dynamic>))
              .toList() ??
          [],
    );
  }
